...
<head>
    ...
    <style>
        ...
        .card-form {
            ...
            box-shadow: 0 2px 16px rgba(25,135,84,0.10);
        }
...
<div class="container py-3">
    <div class="main-header text-center">
        <h2><i class="fa-solid fa-user-plus"></i> Thêm nhân viên</h2>
        <div class="mt-2">Nhập thông tin nhân viên mới</div>
    </div>
    <div class="card card-form p-4 bg-white">
    <form method="post">
        <div class="mb-3">
            <label for="full_name" class="form-label">Họ tên <span class="text-danger">*</span></label>
            <input type="text" name="full_name" id="full_name" class="form-control form-control-lg" value="<?= htmlspecialchars($old['full_name'] ?? '') ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone" id="phone" class="form-control form-control-lg" value="<?= htmlspecialchars($old['phone'] ?? '') ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="position" id="position" class="form-control form-control-lg" value="<?= htmlspecialchars($old['position'] ?? '') ?>">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="salary" id="salary" class="form-control form-control-lg" value="<?= htmlspecialchars($old['salary'] ?? '') ?>">
        ...
        <div class="d-flex justify-content-between mt-4">
            <button class="btn btn-success btn-lg px-4" type="submit"><i class="fa fa-save"></i> Lưu</button>
